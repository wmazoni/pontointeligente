...
class LancamentoServiceTest {
    ...
    fun testBuscarLancamentoPorFuncionarioId() {
        val lancamento: Page<Lancamento>? = lancamentoService?.findByFuncionarioId(id, PageRequest.of(0, 10))
    ...
    fun testPersistirLancamento() {
        val lancamento: Lancamento? = lancamentoService?.insert(lancamento())
        Assertions.assertNotNull(lancamento)
    }
